...
set output "k-recall.svg"

set xlabel "Top-K个数" font "Times New Roman,18"
set ylabel "召回率" font "Times New Roman,18"
...
plot [8:240][0:1] \
"k.txt" using 2:4 title "Top-K扩容算法" with linespoints linecolor 7 linewidth 1 pointtype 11 pointsize 0.8,\
